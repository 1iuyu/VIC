...
void alloc_force(force_data_struct *);
...
int count_grid_cells(FILE *fp);
void compute_cell_area(soil_con_struct *);
void free_atmos(force_data_struct *force);
...
void write_model_state(all_vars_struct *, veg_con_struct *, int, 
                       filep_struct *, soil_con_struct *);
