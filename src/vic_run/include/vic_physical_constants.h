...
#define CONST_AVOGAD 6.02214e23  /**< Avogadro's number ~ molecules/mol */
#define CONST_KARMAN 0.4  /**< Von Karman constant */
/**< molecular weights */
#define CONST_MWDAIR 0.028966   /**< molecular weight of dry air ~ kg/mol */
#define CONST_MWWV   0.018016   /**< molecular weight of water vapor ~ kg/mol */
#define CONST_MWCO2  0.044011   /**< molecular weight of CO2 ~ kg/mol */
#define CONST_MWAIR  0.02897    /**< molecular weight of air ~ kg/mol */
#define CONST_MWC    0.01201    /**< molecular weight of carbon ~ kg/mol */
/**< gas constants */
#define CONST_RGAS (CONST_AVOGAD * CONST_BOLTZ) /**< Universal gas constant ~ J/K/mol */
#define CONST_RDAIR (CONST_RGAS / CONST_MWDAIR)  /**< Dry air gas constant ~ J/K/kg */
#define CONST_RWV (CONST_RGAS / CONST_MWWV)  /**< Water vapor gas constant 461.269 ~ [J/K/kg] */ 
...
#define CONST_CPFWICE 4.188e3  /**< specific heat of fresh h2o ~ J/kg/K */
#define CONST_CPICE 2.116e3  /**< specific heat capacity of ice ~ J/kg/K */
...
#define CONST_VCPFWICE (CONST_CPFWICE * CONST_RHOFW)
/**< latent heats */
#define CONST_LATICE 3.3336e5  /**< latent heat of fusion of water [J/kg] */
#define CONST_LATVAP 2.5104e6  /**< latent heat of vaporization [J/kg] */
#define CONST_LATSUB (CONST_LATICE + CONST_LATVAP)  /**< latent heat of sublimation ~ J/kg */

#define CONST_VAPDIFF 2.12e-5  /**< diffusion coefficient of water vapor molecules under standard conditions (m²/s) */
