...
******************************************************************************/
void
update_snow_fluxes(double    *depth1,
                   double    *liq1,
                   double    *ice1,
                   double    *temp1,
                   double     depth2,
